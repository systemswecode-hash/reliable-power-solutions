      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="flex items-center space-x-2 mb-4">
              <div className="flex items-center justify-center">
                <Link href="/" className="flex items-center space-x-2">
                  <Image src="/logo.svg" alt="Beta-solar Logo" width={40} height={40} className="w-36" priority />
                </Link>
              </div>
            </div>
        ...
        <div className="mt-12 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center pt-8 border-t border-border">
            <p className="text-muted-foreground text-sm">© 2025 Reliable Power and Electricals. All rights reserved.</p>
            <div className="flex items-center space-x-6 mt-4 md:mt-0">
              <Link href="#" className="text-muted-foreground hover:text-green-600 transition-colors text-sm">
                Terms of Service
              </Link>
              <Link href="#" className="text-muted-foreground hover:text-green-600 transition-colors text-sm">
                Privacy Policy
